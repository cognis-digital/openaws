...
useful SUBSET of four AWS-style services for offline development and testing:

    * S3      — object store (buckets / objects)
    * DynamoDB — key/value table store (partition key + optional sort key)
