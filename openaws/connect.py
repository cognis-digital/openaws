"""Native cognis-connect emit for openaws — forward findings to any platform.

Maps openaws's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    openaws ... --format json | openaws-emit --to stix
    openaws-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
